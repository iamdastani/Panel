        ...
        <table>
            ...
            <tbody>
                ...
                <td>
                    ...
                    If your balance drops below the amount you set, you'll get a notification.              </div>
                </td>
...
<span class="tt-icon tt-switch-color" style="color: rgb(153, 153, 153);"><i class="tt-switch-off"></i></span>
                ...
                <td>
                    ...
                    <div class="settings-emails__row-description <?php if($settings["alert_newmanuelservice"] == 1){ echo 'grey'; } ?>">
                       Notification is sent if new manual orders are received.</div>
                </td>
                <td class="settings-emails__td-actions">
             ...
             <tr class="settings-emails__row <?php if($settings["alert_newbankpayment"] == 1){ echo 'grey'; } ?>">
                <td>
                    ...
                    <div class="settings-emails__row-description <?php if($settings["alert_newbankpayment"] == 1){ echo 'grey'; } ?>">
                        A notification will be sent if a new payment request is received.</div>
                </td>
                <td class="settings-emails__td-actions">
...
<span class="tt-icon tt-switch-color" style="color: rgb(153, 153, 153);"><i class="tt-switch-off"></i></span>
                ...
                <td>
                    ...
                    <div class="settings-emails__row-description <?php if($settings["alert_failorder"] == 1){ echo 'grey'; } ?>">
                       A notification is sent if a new failed (Fail) order is received.</div>
                </td>
                <td class="settings-emails__td-actions">
...
<hr>
        <div class="row">
          <div class="col-md-12 form-group">
            ...
            <select class="form-control" name="alert_type">
              <option value="3" <?= $settings["alert_type"] == 3 ? "selected" : null; ?> >Mail Or SMS</option>
        ...
        <div class="form-group col-md-6">
          ...
          <div class="form-group col-md-6">
            <label class="control-label">Password Renewal by Mail</label>
         ...
         <small>The healthiest form of notification is SMS.</small>
        </div>
        </div>
        <hr>
        <div class="row">
          ...
          <div class="col-md-12 help-block">
         <small><i class="fa fa-warning"></i> <code>Bizim SMS</code> Please write your API Key in the password section.</small><br> <small>Pay attention to Turkish characters when writing the SMS Title.</small>
         </div>
        </div>
        <hr>
        <div class="row">
          ...
          <div class="col-md-3 form-group">
            ...
            <select class="form-control" name="smtp_protocol">
              <option value="0" <?= $settings["smtp_protocol"] == 0 ? "selected" : null; ?> >NON</option>
