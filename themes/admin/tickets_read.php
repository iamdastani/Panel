<?php include 'header.php'; ?>
    ...
    <div class="container container-md"> <div class="row"><div class="col-md-12">
                  <ul class="nav nav-tabs"> <a href="/admin/tickets" class="details_backButton btn btn-link"><span>‹</span> Back To Tickets</a><li class="pull-right custom-search">
       ...
       <div class="col-md-12">
        ...
        <div class="row">
            <div class="col-md-12">
               ...
               <span class="badge"><i class="fa fa-lock"></i> Support request is locked, User cannot reply.</span>
               <?php endif; ?>
                        ...
                        <div class="col-md-12">
                           ...
                           <input name="username" value="<?=$user["username"]?>" hidden>
                                ...
                                <a href="<?php echo site_url("admin/tickets/close/".$ticketMessage[0]["ticket_id"]) ?>" class="btn btn-default" data-toggle="modal">
                                    ...
                                    <li> <a href="<?php echo site_url("admin/tickets/lock/".$ticketMessage[0]["ticket_id"]) ?>"  data-toggle="tooltip" data-placement="top" title="" data-original-title="Destek talebini kilitle">Lock And Close Request</a>
                                 </li>  <?php else: ?>
                                     <li><a href="<?php echo site_url("admin/tickets/unlock/".$ticketMessage[0]["ticket_id"]) ?>" data-toggle="tooltip" data-placement="top" title="" data-original-title="Destek talebi kilidini aç">Unlock Ticket</a>
                                </li>   <?php endif; ?>
                                                                            </ul>
                                                            </div>
                                            </div>
