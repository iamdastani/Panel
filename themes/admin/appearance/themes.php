...
<div class="col-md-2 col-md-offset-1">
            <ul class="nav nav-pills nav-stacked p-b">
                              ...
                              <li class="settings_menus "><a href="<?=site_url("admin/appearance/language")?>">Languages</a></li>
                               <li class="settings_menus "><a href="<?=site_url("admin/appearance/files")?>">Files</a></li>
                          </ul>
          </div>
<div class="container">
                <div class="row">
              ...
              <div class="panel-body">
                <div class="row">
                   <div class="col-md-12">
                    ...
                    The document will be added soon...<br> You can access the theme codes of the page you want to edit from the left side.
                      </div>
                    </div>
                  </div>
                  </div>
               ...
               <div class="panel-body">
                ...
                <form action="<?php echo site_url("admin/appearance/themes/".$theme["theme_dirname"]."?file=".$lyt) ?>" method="post" class="twig-editor__form">
                  ...
                  <div class="edit-theme-body-buttons text-right">
                    <button class="btn btn-primary click">Edit Theme</button>
                  </div>
                </form>
