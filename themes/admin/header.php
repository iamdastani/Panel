...
<li class='<?php if( route(1) == 'child-panels' ): echo 'active'; endif; ?>'><a href='<?php echo site_url('admin/child-panels') ?>'>Child Panel 💎
...
<li class='<?php if( route(1) == 'settings' ): echo 'active'; endif; ?>'><a href='<?php echo site_url('admin/settings') ?>'>Settings ⚙️</a></li>
...
echo "<li><a href='#' data-toggle='modal' data-target='#managerModal'><img src='https://i.imgur.com/2oE3xxT.png' width='25' height='20'></a></li>";
else:
echo "<li><a href='#' data-toggle='modal' data-target='#managerModal'><img src='https://i.imgur.com/2oE3xxT.png' width='25' height='20'></a></li>";
endif;
